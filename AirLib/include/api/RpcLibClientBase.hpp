...
namespace airlib
{
    ...
    public:
		...
		bool simAddObstacle(const Pose& pose, float speed = 1000.0, const std::string& obstacle_name = "");
		...
		vector<Vector2r> getRelLocation(const Vector2r& initial_location = Vector2r(0, 0)) const;
