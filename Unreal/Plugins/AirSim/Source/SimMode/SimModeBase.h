...
public:
    ...
    std::vector<FVector2D> getGoal(int distance = 12, FVector2D initial_location = FVector2D(0, 0));

    std::vector<FVector2D> getRelLocation(FVector2D initial_location = FVector2D(0,0));
